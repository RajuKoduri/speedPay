...
export class SummaryReportComponent implements OnInit {
  ...
  onFormSubmit() {
    ...
    // fillterbody["startDate"] = { "start": this.filterForm.value.startDate + "T" + this.filterForm.value.startTime, "end": this.filterForm.value.endDate + "T" + this.filterForm.value.endTime },
    ...
    (this.filterForm.value.endDate != null && this.filterForm.value.endDate != "") ? { "end": this.filterForm.value.endDate + "T" + this.filterForm.value.endTime } : undefined;
      ...
      this.ToolsService.getSkinsDateAggr(fillterbody).subscribe((data) => { this.SummaryResData(data) })
  }

  SummaryResData(data: any) {
    console.log(data);
    this.loader = false;
    this.SummaryReportdata = data.objectList;
  ...
  exportexcel(): void {
    ...
    XLSX.writeFile(wb, 'SummaryReportdataExcelSheet.xlsx');
  ...
  fastforward() {
    ...
    console.log(this.SummaryReportdata.length)
    this.pagecontrolbtn = true;
    if (this.PageCount > this.SummaryReportdata.length) {
      this.pagecontrolbtn = true;
    }
