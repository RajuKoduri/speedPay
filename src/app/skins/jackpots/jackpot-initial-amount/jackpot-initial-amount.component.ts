...
@Component({
  selector: 'app-jackpot-initial-amount',
  templateUrl: './jackpot-initial-amount.component.html',
  styleUrls: ['./jackpot-initial-amount.component.css']
})
export class JackpotInitialAmountComponent implements OnInit,OnDestroy {
  ...
  onFormSubmit() {
    ...
    fillterbody["creatorLogin"] = this.filterForm.value.user != null ? this.filterForm.value.user : undefined,
      ...
      fillterbody["types"] = [this.Operation[1].guid]
