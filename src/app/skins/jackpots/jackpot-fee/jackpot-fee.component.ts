...
@Component({
  selector: 'app-jackpot-fee',
  templateUrl: './jackpot-fee.component.html',
  styleUrls: ['./jackpot-fee.component.css']
})
export class JackpotFeeComponent implements OnInit,OnDestroy {
  ...
  onFormSubmit() {
    ...
    fillterbody["types"] = [this.Operation[4].guid];
