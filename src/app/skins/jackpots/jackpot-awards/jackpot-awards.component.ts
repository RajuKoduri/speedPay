...
@Component({
  selector: 'app-jackpot-awards',
  templateUrl: './jackpot-awards.component.html',
  styleUrls: ['./jackpot-awards.component.css']
})
export class JackpotAwardsComponent implements OnInit, OnDestroy {
  ...
  constructor(private Jackpotsservice: JackpotsService, private FileformatServiceService: FileformatServiceService, private GamesofpokerService: GamesofpokerService,
  ...
  onFormSubmit() {
    ...
    fillterbody["types"] = [this.Operation[3].guid];
